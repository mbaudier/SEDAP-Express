...
public class SECMockUpSeitenbuch extends SECMockUpHMI {
	...
	public static void zoomTo(WorldWindow wwd, Sector sector) {
		...
		// Configure OrbitView to look at the center of the sector from our estimated
		// distance. This causes OrbitView to
		// animate to the specified position over several seconds. To affect this change
